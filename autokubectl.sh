...
autokube_command_not_found_handle_map_res[dep]='deployment.apps'
autokube_command_not_found_handle_map_res[ing]='ingress.networking.k8s.io'
autokube_command_not_found_handle_map_res[pvc]='pvc'
autokube_command_not_found_handle_map_res[sec]='secret'
autokube_command_not_found_handle_map_res[sts]='statefulset.apps'
autokube_command_not_found_handle_map_res[svc]='service'
#2
autokube_command_not_found_handle_map_res[cm]='configmap'
autokube_command_not_found_handle_map_res[cr]='clusterrole.rbac.authorization.k8s.io'
autokube_command_not_found_handle_map_res[dc]='deploymentconfig.apps.openshift.io'
...
autokube_command_not_found_handle_map_res[rb]='rolebinding.rbac.authorization.k8s.io'
autokube_command_not_found_handle_map_res[rs]='replicaset.apps'
